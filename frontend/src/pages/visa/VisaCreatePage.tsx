...
const VisaCreatePage = () => {
  ...
  useEffect(() => {
    const loadLookups = async () => {
      ...
      try {
        ...
        setBookingOptions(
          (Array.isArray(bookingsData) ? bookingsData : []).map(
            (booking: any) => {
              const bookingNumber =
  ...
  const bookingDropdownOptions = useMemo(
    () => [
      ...
      ...bookingOptions.map(item => ({ value: item.id, label: item.label }))
    ],
    [bookingOptions]
  )
  ...
  const supplierDropdownOptions = useMemo(
    () => [
      ...
      ...supplierOptions.map(item => ({ value: item.id, label: item.label }))
    ],
    [supplierOptions]
  )
  ...
  const handleSave = async () => {
    if (!form.bookingId) {
      setError(
        'Booking is required so the visa case stays linked to CRM operations.'
      )
      return
    }
        ...
        <div className='flex items-start gap-3'>
          ...
          <div>
            ...
            <p className='mt-1 text-sm text-gray-500 dark:text-gray-400'>
              Link booking and supplier with a proper visa workflow stage
              instead of typing raw IDs.
            </p>
          </div>
        </div>
      </div>
          ...
          <SurfaceCard className='border border-gray-200 p-5 dark:border-gray-800'>
            <div className='mb-4'>
              ...
              <p className='text-sm text-gray-500 dark:text-gray-400'>
                Booking linkage is important because checklist, follow-up, and
                finance context stay connected.
              </p>
            </div>
            ...
            <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
              <div className='md:col-span-2'>
                ...
                <SearchableDropdown
                  ...
                  onChange={value =>
                    setForm(prev => ({ ...prev, bookingId: value }))
                  }
              ...
              <div>
                ...
                <input
                  ...
                  value={form.visaType}
                  onChange={e =>
                    setForm(prev => ({ ...prev, visaType: e.target.value }))
                  }
                />
              </div>
              ...
              <div>
                ...
                <SearchableDropdown
                  ...
                  onChange={value =>
                    setForm(prev => ({
                      ...prev,
                      workflowStage: value as VisaWorkflowStage
                    }))
                  }
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    setForm(prev => ({ ...prev, visaNumber: e.target.value }))
                  }
                />
              </div>
            ...
            <div className='flex items-start gap-3'>
              ...
              <div>
                ...
                <p className='mt-1 text-sm text-blue-800 dark:text-blue-200'>
                  Docs ke according visa case ko document collection se start
                  karke submitted, biometrics, under process, approved/rejected,
                  aur delivered tak track karna chahiye.
                </p>
              </div>
            </div>
          </SurfaceCard>
