        ...
        <div className='relative z-10 grid min-h-screen lg:grid-cols-[1.15fr_0.85fr]'>
          ...
          <section className='hidden lg:flex relative flex-col px-12 py-12 xl:px-16 xl:py-14 overflow-hidden'>
            ...
            <div className='absolute inset-0'>
              <div
                className='absolute -top-28 -left-28 h-80 w-80 rounded-full bg-blue-500/25 blur-3xl'
                style={{ animation: 'floatSoft 10s ease-in-out infinite' }}
              />
              <div
                className='absolute top-16 right-[-7rem] h-72 w-72 rounded-full bg-cyan-400/20 blur-3xl'
                style={{ animation: 'floatWide 9s ease-in-out infinite' }}
              />
              <div
                className='absolute bottom-6 left-1/3 h-64 w-64 rounded-full bg-indigo-400/20 blur-3xl'
              ...
              <div
                className='absolute inset-x-0 top-24 h-px bg-gradient-to-r from-transparent via-blue-500/70 to-transparent'
                style={{ animation: 'scanPulse 6s ease-in-out infinite' }}
              />
              <div
                className='absolute inset-x-0 bottom-28 h-px bg-gradient-to-r from-transparent via-cyan-400/70 to-transparent'
                style={{ animation: 'scanPulse 7.5s ease-in-out infinite' }}
              />
            </div>
            ...
            <div className='relative z-10 mt-8 max-w-md space-y-4'>
              <h1 className='text-4xl font-semibold leading-tight text-slate-900'>
                Run travel demand in real time.
              </h1>
              <p className='text-sm text-slate-600'>
                A high-performance CRM for holidays and visas with SLA control,
                revenue visibility, and automated follow-ups.
              </p>
            ...
            <div className='relative z-10 mt-8 flex-1'>
              <div
                className='relative h-[520px] w-full group'
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    transform: `perspective(1200px) rotateX(${heroTilt.x.toFixed(
                      2
                    )}deg) rotateY(${heroTilt.y.toFixed(2)}deg) scale(1.01)`
                  }}
                >
                  ...
                  {[280, 220, 170, 130].map((size, index) => (
                    <div
                      ...
                      style={{
                        ...
                        marginTop: `-${size / 2}px`,
                        animation: `orbit ${18 + index * 6}s linear infinite ${
                          index % 2 === 0 ? '' : 'reverse'
                        }`
                      }}
                    >
                  ...
                  <div
                    className='absolute left-1/2 top-1/2 h-8 w-8 -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-600 shadow-[0_0_40px_rgba(37,99,235,0.85)]'
                    style={{ animation: 'pulseCore 4s ease-in-out infinite' }}
                  />
                  ...
                  <div
                    className='absolute left-0 top-[18%] h-[2px] w-1/2 bg-gradient-to-r from-transparent via-blue-500/80 to-transparent'
                    style={{ animation: 'comet 6s ease-in-out infinite' }}
                  />
                  <div
                    className='absolute right-0 bottom-[22%] h-[2px] w-1/2 bg-gradient-to-l from-transparent via-cyan-500/70 to-transparent'
                    style={{ animation: 'comet 7.2s ease-in-out infinite' }}
                  />
                  <div
                    className='absolute left-1/4 bottom-[10%] h-[1px] w-1/2 bg-gradient-to-r from-transparent via-indigo-400/50 to-transparent'
                    style={{ animation: 'comet 8.5s ease-in-out infinite' }}
                  />

                  <div className='absolute left-8 top-8 text-[11px] font-semibold text-blue-600'>
                    SLA 14:23
                  </div>
                  <div className='absolute right-8 bottom-12 text-[11px] font-semibold text-cyan-600'>
                    Routing Active
                  </div>
                  <div className='absolute left-12 bottom-10 text-[11px] font-semibold text-indigo-600'>
                    Auto Follow-ups
                  </div>
                </div>
              </div>
            ...
            <p className='relative z-10 mt-6 text-xs text-slate-400'>
              Built for Indian travel agencies and multi-branch ops.
            </p>
          </section>
