...
const SuppliersPage: React.FC = () => {
  ...
  const filteredAndSortedSuppliers = useMemo(() => {
    ...
    const filtered = suppliers.filter((supplier) => {
      ...
      const searchMatch =
        !query ||
        `${supplier.name} ${supplier.contactPerson} ${supplier.email} ${supplier.country}`
          .toLowerCase()
          .includes(query);
          ...
          <div id="ssnnumber">
            ...
            <input
              ...
              onChange={(e) =>
                setSupplierForm((prev) => ({
                  ...prev,
                  ssnNumber: e.target.value.toUpperCase(),
                }))
              }
          ...
          <div id="ninonumber">
            ...
            <input
              ...
              onChange={(e) =>
                setSupplierForm((prev) => ({
                  ...prev,
                  ninoNumber: e.target.value.toUpperCase(),
                }))
              }
              className="field-input"
          ...
          <div id="sinnumber">
            ...
            <input
              ...
              onChange={(e) =>
                setSupplierForm((prev) => ({
                  ...prev,
                  sinNumber: e.target.value.toUpperCase(),
                }))
              }
              className="field-input"
              placeholder=""
          ...
          <div id="tfnnumber">
            ...
            <input
              ...
              onChange={(e) =>
                setSupplierForm((prev) => ({
                  ...prev,
                  tfnNumber: e.target.value.toUpperCase(),
                }))
              }
              className="field-input"
            ...
            <table className="w-full">
              <thead className="bg-gray-50 dark:bg-gray-800/50">
                <tr className="border-b border-gray-200 dark:border-gray-700">
                  ...
                  <th className="px-4 py-3 text-center text-xs font-semibold uppercase text-gray-600 dark:text-gray-400">
                    Status
                  </th>
                  ...
                  <div>
                    ...
                    <SearchableDropdown
                      ...
                      onChange={(value) =>
                        setSupplierForm((prev) => ({
                          ...prev,
                          supplierCurrency: String(value || "").toUpperCase(),
                        }))
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSupplierForm((prev) => ({
                          ...prev,
                          paymentDeadlineDate: e.target.value,
                        }))
                      }
                      className="field-input"
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSupplierForm((prev) => ({
                          ...prev,
                          invoiceIfscSwift: e.target.value.toUpperCase(),
                        }))
                      }
                      className="field-input"
                  ...
                  <div className="md:col-span-2 lg:col-span-3">
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        setSupplierForm((prev) => ({
                          ...prev,
                          productionCommitment: e.target.value,
                        }))
                      }
                      className="field-input"
