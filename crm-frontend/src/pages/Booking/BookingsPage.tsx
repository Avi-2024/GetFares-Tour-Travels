...
const getLocalNowDateTimeInputValue = () => {
  const now = new Date()
  const offsetMs = now.getTimezoneOffset() * 60 * 1000
        ...
        <div className='p-6 space-y-4'>
          ...
          <div className='grid grid-cols-2 gap-4'>
            ...
            <div>
              ...
              <input
                type='date'
                min={formData.travelStart || getLocalTodayIsoDate()}
          ...
          <div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
              <div>
                ...
                <input
                  type='datetime-local'
                  min={getLocalNowDateTimeInputValue()}
              ...
              <div>
                ...
                <input
                  ...
                  className='field-input text-gray-900 dark:text-gray-100'
                />
              </div>
              <div>
...
const BookingsPage: React.FC = () => {
  ...
  const handleApproveBooking = async (bookingId: string) => {
    ...
    try {
      ...
      showToast(getApiErrorMessage(error, 'Failed to approve booking'), 'error')
    } finally {
      setLoading(false)
    }
  }
  ...
  const filtered = useMemo(() => {
    return bookingItems.filter(booking => {
      ...
      if (
        ...
        booking.status !== appliedFilters.status
      )
        return false
      if (
              ...
              <div>
                ...
                <SearchableDropdown
                  ...
                  onChange={value =>
                    updateDraftFilter(
                      'status',
                      value as BookingFilterState['status']
                    )
                  }
                />
              </div>
              <div>
                ...
                <SearchableDropdown
                  ...
                  onChange={value =>
                    updateDraftFilter(
                      'payment',
                      value as BookingFilterState['payment']
                    )
                  }
                />
              </div>
              <div>
                ...
                <SearchableDropdown
                  ...
                  onChange={value =>
                    updateDraftFilter(
                      'risk',
                      value as BookingFilterState['risk']
                    )
                  }
                />
              </div>
              ...
              <div className='xl:max-w-xs'>
                ...
                <SearchableDropdown
                  ...
                  onChange={value =>
                    updateDraftFilter(
                      'sortBy',
                      value as BookingFilterState['sortBy']
                    )
                  }
                />
              </div>
