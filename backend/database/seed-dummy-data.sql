...
INSERT INTO suppliers (name, email, phone, country, is_active) VALUES
('Bali Tours & Travel', 'contact@balitoursandtravel.com', '+62-274-555-123', 'Indonesia', true),
('Maldives Resorts Ltd', 'bookings@maldivesresorts.mv', '+960-330-5000', 'Maldives', true),
('Dubai Tourism Services', 'info@dubaytourism.ae', '+971-4-308-1111', 'UAE', true),
('Singapore Tours', 'hello@singaporetours.sg', '+65-6737-9110', 'Singapore', true),
('Goa Beach Resorts', 'reservations@goabeachresorts.com', '+91-832-2435-600', 'India', true)
ON CONFLICT(email) DO NOTHING;
