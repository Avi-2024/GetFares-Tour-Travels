...
class CmsEntityFormCatalog {
  ...
  private static sectionByKey: Record<CmsSectionKey, CmsEntityFormDefinition> = {
    ...
    "published-packages": {
      ...
      groups: [
        {
          key: "basic",
          title: "Basic Information",
          description: "Primary package attributes.",
          columns: 2,
        },
        {
          key: "content",
          title: "Content Details",
          description: "Package details and policy fields.",
          columns: 2,
          collapsible: true,
        },
        {
          key: "seo",
          title: "SEO",
          description: "Website metadata and slug.",
          columns: 2,
          collapsible: true,
        },
        {
      ...
      fields: [
        { key: "name", label: "Package Name", type: "text", required: true, groupKey: "basic" },
        { key: "destination", label: "Destination", type: "text", required: true, groupKey: "basic" },
        { key: "duration", label: "Duration", type: "text", groupKey: "basic" },
        { key: "startingPrice", label: "Starting Price", type: "number", required: true, groupKey: "basic" },
        { key: "packageCategory", label: "Category", type: "text", groupKey: "content" },
        { key: "inclusions", label: "Inclusions", type: "textarea", groupKey: "content" },
        { key: "exclusions", label: "Exclusions", type: "textarea", groupKey: "content" },
        { key: "hotelDetails", label: "Hotel Details", type: "textarea", groupKey: "content" },
        { key: "cancellationPolicy", label: "Cancellation Policy", type: "textarea", groupKey: "content" },
        { key: "metaTitle", label: "Meta Title", type: "text", groupKey: "seo" },
        { key: "metaDescription", label: "Meta Description", type: "textarea", groupKey: "seo" },
        { key: "websiteSlug", label: "Website Slug", type: "text", groupKey: "seo", autoSlugSource: "name" },
        { key: "status", label: "Status", type: "select", groupKey: "status", options: [{ label: "Draft", value: "DRAFT" }, { label: "Published", value: "PUBLISHED" }] },
        { key: "publishToWebsite", label: "Publish To Website", type: "switch", groupKey: "status" },
        { key: "isSoldOut", label: "Sold Out", type: "switch", groupKey: "status" },
      ],
    },
    "main-packages": {
    ...
    "sub-packages": {
      ...
      fields: [
        { key: "mainPackageId", label: "Main Package", type: "searchable-select", relationSource: "main-packages", required: true, groupKey: "basic" },
        { key: "packageId", label: "Published Package", type: "searchable-select", relationSource: "published-packages", required: true, groupKey: "basic" },
